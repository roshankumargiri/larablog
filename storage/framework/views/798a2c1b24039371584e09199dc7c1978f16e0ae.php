<form action=" <?php echo e(route('backend.blog.update',$post->id)); ?>" method="POST" role="form" enctype="multipart/form-data">
    <?php echo csrf_field(); ?>
        ...
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="excerpt form-group<?php echo e($errors->has('excerpt') ? ' has-error' : ''); ?>">
                    ...
                    <textarea name="excerpt" id="excerpt" rows="5" class="form-control"><?php echo e($post->excerpt); ?></textarea>
            ...
            <div class="box-body">
                <div class="form-group<?php echo e($errors->has('published_at') ? ' has-error' : ''); ?>">
                    ...
                    <div class='input-group date' id='datetimepicker1'>
                        <input name="published_at" value="<?php echo e($post->published_at); ?>" type='text' class="form-control" />
                ...
                <div class="form-group<?php echo e($errors->has('image') ? ' has-error' : ''); ?>">
                    <div class="fileinput fileinput-new" data-provides="fileinput">
                        <div class="fileinput-new img-thumbnail" style="width: 200px; height: 150px;">
                            <img src="<?php echo e(($post->image_url) ? $post->image_url : 'http://placehold.it/200x150&text=No+Image'); ?>"
                                alt="...">
                        </div>
...
<?php /**PATH E:\laravel\blog\resources\views/backend/blog/editform.blade.php ENDPATH**/ ?>