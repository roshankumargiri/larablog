<form action=" {{route('backend.blog.update',$post->id)}}" method="POST" role="form" enctype="multipart/form-data">
    @csrf
    @method('PUT')
    <div class="col-xs-9">
        <div class="box">
            ...
            <div class="box-body">
                ...
                <div class="excerpt form-group{{$errors->has('excerpt') ? ' has-error' : ''}}">
                    ...
                    <textarea name="excerpt" id="excerpt" rows="5" class="form-control">{{$post->excerpt}}</textarea>
            ...
            <div class="box-body">
                <div class="form-group{{$errors->has('published_at') ? ' has-error' : ''}}">
                    ...
                    <div class='input-group date' id='datetimepicker1'>
                        <input name="published_at" value="{{$post->published_at}}" type='text' class="form-control" />
                ...
                <div class="form-group{{$errors->has('image') ? ' has-error' : ''}}">
                    <div class="fileinput fileinput-new" data-provides="fileinput">
                        <div class="fileinput-new img-thumbnail" style="width: 200px; height: 150px;">
                            <img src="{{($post->image_url) ? $post->image_url : 'http://placehold.it/200x150&text=No+Image'}}"
                                alt="...">
                        </div>
